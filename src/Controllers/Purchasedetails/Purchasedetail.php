        ...
        switch ($this->mode) {
            case "INS":
                ...
                $this->validateDBOperation(
                    "Purchasedetail creada exitosamente",
                    "Ocurrio un error al crear el purchasedetail",
                    $insResult
                );
                break;
            ...
            case "UPD":
                ...
                $this->validateDBOperation(
                    "Purchasedetail actualizada exitosamente",
                    "Ocurrio un error al actualizar el purchasedetail",
                    $updResult
                );
                break;
            ...
            case "DEL":
                ...
                $this->validateDBOperation(
                    "Purchasedetail eliminada exitosamente",
                    "Ocurrio un error al eliminar el purchasedetail",
                    $delResult
                );
                break;
        }
