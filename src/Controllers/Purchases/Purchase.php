        ...
        switch ($this->mode) {
            case "INS":
                ...
                $this->validateDBOperation(
                    "Purchase insertado correctamente",
                    "Ocurrio un error al insertar el purchase",
                    $insResult
                );
                break;
            ...
            case "UPD":
                ...
                $this->validateDBOperation(
                    "Purchase actualizado correctamente",
                    "Ocurrio un error al actualizar el purchase",
                    $updResult
                );
                break;
            ...
            case "DEL":
                ...
                $this->validateDBOperation(
                    "Purchase eliminado correctamente",
                    "Ocurrio un error al eliminar el purchase",
                    $delResult
                );
                break;
        }
